## latexDate and latexify copied from dplR 1.6.6
## latexDate and latexify are GPL-3 licensed, Copyright (c) 2017 Andy Bunn
## Modifications Copyright (c) 2017 Shawn Garbett and GPL-3
