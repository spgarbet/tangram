...
To create a SMD statistic in the style of tableone inside of tangram. See '[Using standardized mean differences](https://cran.r-project.org/web/packages/tableone/vignettes/smd.html)' by Kazuki Yoshida for original work and description of method. This is a reproduction of the original document using `tangram`.
...
tangram(formula, rhc, "unmatched", smd, "Unmatched", style="nejm")
```
...
tangram(formula, rhcMatched, "matched", smd, "Propesnity Score Matched", style="nejm")
```
