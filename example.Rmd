...
```{r, results="asis"}
html5(summary_table(drug ~ bili + albumin + stage::Categorical + protime + sex + age + spiders, pbc), fragment=TRUE, id="fig1")
```
